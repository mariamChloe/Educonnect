...
class _MyOnboardingScreenState extends State<OnboardingScreen> { 
  ...
  final pages = [ 
    ...
    subtitle: 'Decouvrez comment EduConnect simplifie la gestion de votre classe',
  ),
  OnboardingPage(
    color: Colors.white,
    image: 'assets/onboarding2png (2).png',
    title: 'ENREGISTREMENT',
    subtitle: 'Enregistrer en un clic les notes et l‘assiduitées de vos élèves',
  ),

  OnboardingPage(
    color: Colors.white,
    image: 'assets/Fichier3.png',
    title: 'Prêt(e)?',
    subtitle: 'Appuyez sur "commencer" pour decouvrir comment EduConnect peut ameliorer votre enseignement.',
  ),
  ...
  void _onSkip() => _controller.jumpToPage(
      pages.length ); 
  ...
  return Align(
    ...
    child: Padding(
      ...
      decoration: BoxDecoration(
        borderRadius: BorderRadius.circular(9), // Ajustez le rayon de l'arrondi selon vos préférences
      ...
      child: TextButton(
        style: TextButton.styleFrom(
          ...
          backgroundColor:AppTheme.principalColor,///Changez thirdColor
  ...
  Widget build(BuildContext context) { 
    return Scaffold( 
      body: Stack( 
        ...
        // Integrate this in the code listed above (OnboardingScreen)
            Padding( 
              ...
              child: Align( 
                ...
                child: SmoothPageIndicator( 
                  ...
                  count: pages.length, 
                  effect: SlideEffect( 
                    dotColor:AppTheme.hintGray, 
                    activeDotColor: AppTheme.principalColor 
                  ), 

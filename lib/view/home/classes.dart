                      ...
                      child: Column(
                        children: [
                          Row(
                            ...
                            children: [
                              Text("Listes des classes " , style: TextStyle( fontWeight: FontWeight.bold , fontSize: 28 , color:Color.fromRGBO(67, 180, 253, 1))),
                              Image(image: AssetImage("assets/user-check.png"))
                            ],
                          ),
                          Padding(padding: EdgeInsets.only(top: 10) , child: Text("Vous pouvez vérifiez la liste de toutes les classes que vous prenez ici." , style: TextStyle( fontSize: 15 , color:Color.fromRGBO(174, 126, 13, 1)),),),
                        ],
                      ),
                    ...
                    Container(
                      ...
                      child: Row(
                        ...
                        children: [
                         ...
                         Navigator.push(context, MaterialPageRoute(builder: (context) => ListeClasseScreen()));
                          ...
                          child:Container(
                            ...
                            child: Row(
                              children: [
                                Text(" Faire l'appel" , style: TextStyle(color:Colors.white),)
                              ],
